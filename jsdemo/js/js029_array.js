...
console.log(`potin length : ${point.length}`);
...
console.log(`res_map : ${res}`); // 8,18,32,50

const sqt = numbers.map(Math.sqrt);
console.log(`sqt_map : ${sqt}`); //2,3,4,5
